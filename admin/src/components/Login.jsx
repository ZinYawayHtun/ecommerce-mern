            ...
            <div className='bg-white shadow-md rounded-lg px-8 py-6 max-w-md'>
                ...
                <form action="" onSubmit={onSubmitHandler}>
                    <div className='mb-3 min-w-72'>
                        ...
                        <input className='rounded-md w-full px-3 py-2 border border-gray-300 outline-none' type="email" placeholder='youremail@gmail.com' required onChange={(e) => setEmail(e.target.value)} value={email} />
                    </div>
                    <div className='mb-3 min-w-72'>
